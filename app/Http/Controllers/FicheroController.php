...
class FicheroController extends Controller
{
    ...
    public function update(Request $request, Fichero $fichero)
    {
        ...
        if ($request->hasFile('foto_perfil')) {
            ...
            $nuevoNombre = Carbon::now()->timestamp . "foto_perfil" . "" . $nombreArchivoOriginal;
        ...
        if ($request->hasFile('banner')) {
            ...
            $nuevoNombre = Carbon::now()->timestamp . "banner" . "" . $nombreArchivoOriginal;
            $carpetaDestino = './ficheros/' . $user->email . '/' . $fichero->id . "/";
        ...
        if ($request->hasFile('foto_1')) {
            ...
            $nuevoNombre = Carbon::now()->timestamp . "foto_1" . "" . $nombreArchivoOriginal;
            $carpetaDestino = './ficheros/' . $user->email . '/' . $fichero->id . "/";
        ...
        if ($request->hasFile('foto_2')) {
            ...
            $nuevoNombre = Carbon::now()->timestamp . "foto_2" . "" . $nombreArchivoOriginal;
            $carpetaDestino = './ficheros/' . $user->email . '/' . $fichero->id . "/";
        ...
        if ($request->hasFile('foto_3')) {
            ...
            $nuevoNombre = Carbon::now()->timestamp . "foto_3" . "" . $nombreArchivoOriginal;
            $carpetaDestino = './ficheros/' . $user->email . '/' . $fichero->id . "/";
        ...
        if ($request->hasFile('foto_4')) {
            ...
            $nuevoNombre = Carbon::now()->timestamp . "foto_4" . "" . $nombreArchivoOriginal;
            $carpetaDestino = './ficheros/' . $user->email . '/' . $fichero->id . "/";
        ...
        if ($request->hasFile('foto_5')) {
            ...
            $nuevoNombre = Carbon::now()->timestamp . "foto_5" . "" . $nombreArchivoOriginal;
            $carpetaDestino = './ficheros/' . $user->email . '/' . $fichero->id . "/";
        ...
        if ($request->hasFile('pdf')) {
            ...
            $nuevoNombre = Carbon::now()->timestamp . "pdf" . "" . $nombreArchivoOriginal;
            $carpetaDestino = './ficheros/' . $user->email . '/' . $fichero->id . "/";
